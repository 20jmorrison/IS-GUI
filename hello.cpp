...
// ------------ PACKET GROUPS --------------
  ...
  Fl_Group *group2 = new Fl_Group(x_packet_offset + 230,y_packet_offset, 200, 270, "ERPA PACKET"); // ERPA packet group
  group2->box(FL_BORDER_BOX);
  group2->labelfont(FL_BOLD);
  Fl_Box *ERPA1 = new Fl_Box(x_packet_offset + 233, y_packet_offset + 5, 50, 20, "SYNC:");
  Fl_Output *ERPAsync = new Fl_Output(x_packet_offset + 350, y_packet_offset + 5, 60,20);
  ...
  Fl_Box *ERPA2 = new Fl_Box(x_packet_offset + 233, y_packet_offset + 25, 50, 20, "SEQ:");
  Fl_Output *ERPAseq = new Fl_Output(x_packet_offset + 350, y_packet_offset + 25, 60,20);
  ...
  Fl_Box *ERPA3 = new Fl_Box(x_packet_offset + 233, y_packet_offset + 45, 50, 20, "ADC:");
  Fl_Output *ERPAadc = new Fl_Output(x_packet_offset + 350, y_packet_offset + 45, 60,20);
  ...
  Fl_Box *ERPA4 = new Fl_Box(x_packet_offset + 233, y_packet_offset + 65, 50, 20, "SWP:");
  Fl_Output *ERPAswp = new Fl_Output(x_packet_offset + 350,y_packet_offset +  65, 60,20);
  ...
  Fl_Box *ERPA5 = new Fl_Box(x_packet_offset + 233, y_packet_offset + 105, 50, 20, "TEMP1:");
  Fl_Output *ERPAtemp1 = new Fl_Output(x_packet_offset + 350,y_packet_offset +  105, 60,20);
  ...
  Fl_Box *ERPA6 = new Fl_Box(x_packet_offset + 233,y_packet_offset +  125, 50, 20, "TEMP2:");
  Fl_Output *ERPAtemp2 = new Fl_Output(x_packet_offset + 350,y_packet_offset +  125, 60,20);
  ...
  Fl_Box *ERPA7 = new Fl_Box(x_packet_offset + 233, y_packet_offset + 145, 50, 20, "ENDmon:");
  Fl_Output *ERPAendmon = new Fl_Output(x_packet_offset + 350, y_packet_offset + 145, 60,20);
  ...
  Fl_Group *group3 = new Fl_Group(x_packet_offset + 445,y_packet_offset, 200, 270, "HK PACKET"); // HK packet group
  group3->box(FL_BORDER_BOX);
  group3->labelfont(FL_BOLD);
  Fl_Box *HK1 = new Fl_Box(x_packet_offset + 448, y_packet_offset + 5, 50, 20, "SYNC:");
  Fl_Output *HKsync = new Fl_Output(x_packet_offset + 565, y_packet_offset + 5, 60,20);
  ...
  Fl_Box *HK2 = new Fl_Box(x_packet_offset + 448, y_packet_offset + 25, 50, 20, "SEQ:");
  Fl_Output *HKseq = new Fl_Output(x_packet_offset + 565,y_packet_offset +  25, 60,20);
  ...
  Fl_Box *HK3 = new Fl_Box(x_packet_offset + 448, y_packet_offset + 45, 50, 20, "BUSvmon:");
  Fl_Output *HKbusvmon = new Fl_Output(x_packet_offset + 565,y_packet_offset +  45, 60,20);
  ...
  Fl_Box *HK4 = new Fl_Box(x_packet_offset + 448, y_packet_offset + 65, 50, 20, "BUSimon:");
  Fl_Output *HKbusimon = new Fl_Output(x_packet_offset + 565, y_packet_offset + 65, 60,20);
  ...
  Fl_Box *HK5 = new Fl_Box(x_packet_offset + 448, y_packet_offset + 105, 50, 20, "2.5vmon:");
  Fl_Output *HK25vmon = new Fl_Output(x_packet_offset + 565, y_packet_offset + 105, 60,20);
  ...
  Fl_Box *HK6 = new Fl_Box(x_packet_offset + 448, y_packet_offset + 125, 50, 20, "3.3vmon:");
  Fl_Output *HK33vmon = new Fl_Output(x_packet_offset + 565, y_packet_offset + 125, 60,20);
  ...
  Fl_Box *HK7 = new Fl_Box(x_packet_offset + 448, y_packet_offset + 145, 50, 20, "5vmon:");
  Fl_Output *HK5vmon = new Fl_Output(x_packet_offset + 565, y_packet_offset + 145, 60,20);
  ...
  Fl_Box *HK8 = new Fl_Box(x_packet_offset + 448, y_packet_offset + 185, 50, 20, "5vref:");
  Fl_Output *HK5vref = new Fl_Output(x_packet_offset + 565, y_packet_offset + 185, 60,20);
  ...
  Fl_Box *HK9 = new Fl_Box(x_packet_offset + 448, y_packet_offset + 205, 50, 20, "15v:");
  Fl_Output *HK15v = new Fl_Output(x_packet_offset + 565, y_packet_offset + 205, 60,20);
  ...
  Fl_Box *HK10 = new Fl_Box(x_packet_offset + 448, y_packet_offset + 225, 50, 20, "N3v3:");
  Fl_Output *HKn3v3 = new Fl_Output(x_packet_offset + 565, y_packet_offset + 225, 60,20);
  ...
  Fl_Box *HK11 = new Fl_Box(x_packet_offset + 448,y_packet_offset +  245, 50, 20, "N5v:");
  Fl_Output *HKn5v = new Fl_Output(x_packet_offset + 565, y_packet_offset + 245, 60,20);
